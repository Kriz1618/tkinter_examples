...
heading_text = Label(app, text='Welcome to the internet speed evaluator App', font='Arial 16 bold', fg='yellow', bg='black')
web_url = Label(app, text='Type an url', font='Arial 14 bold', fg='white', bg='blue')
ping_result = Label(app, text='Ping Result:', font='Arial 14 bold', fg='white', bg='red')
download_result = Label(app, text='Download Result:', font='Arial 14 bold', fg='white', bg='brown')
...
btn = Button(app, text='Check Speed', font='Arial 14', fg='black', bg='green', border=5, command=speed_test)
